...
- **Фаз 5 (⏭️ алгассан — эрсдэл>өгөөж):** `searchParent` (эцэг/эх) нь API-backed + давхар input (нэр+№) + баялаг дүрслэл (зүс/он/удам badge) — searchableDropdown-ийн native-select загварт нийцэхгүй, критик удмын код тул дахин бичихгүй. Task picker (multi-select) ба `dbDdSearch` (custom positioning) мөн цэвэр drop-in биш. Гурвуулаа ажиллаж байгаа тул хэвээр.
- **Фаз 6 (⏭️ алгассан — эрсдэл>өгөөж):** аймаг/сум cascade (`f-province/f-sum, q-sg-venue-*, eq-*`). Шалтгаан: (1) **жижиг жагсаалт** — 21 аймаг, ~20 сум → native select scroll хангалттай, search бараг ашиггүй; (2) **cascade** — province→sum дахин барих 4+ handler (`updateSumList, naadamGazarAimagChange, editAimagChange`...); (3) **dual-mode** select+text (гараар бичих боломж, `display:none` toggle) — naadam-name-тэй адил зохицохгүй; (4) **optgroup** (Нийслэл/Аймгууд) хавтгайрч алдагдана. Native хэвээр үлдээх нь зөв.
